...
import { ApiError, createTransaction, listCategories } from "@/lib/transactions-api";
import { createSchema, type CreateTransactionInput } from "@features/transactions/shared/schemas";
...
export function CreateTransactionForm() {
  ...
  return (
    <form onSubmit={onSubmit} style={{ display: "grid", gap: "1rem", maxWidth: "32rem" }}>
      <FormField label={t("amount")} error={form.formState.errors.amount?.message}>
        <Input type="text" inputMode="decimal" {...form.register("amount")} />
      </FormField>
      <FormField label={t("currency")} error={form.formState.errors.currencyCode?.message}>
      ...
      <FormField label={t("category")} error={form.formState.errors.categoryId?.message}>
        <Select
      ...
      <FormField label={t("occurredAt")} error={form.formState.errors.occurredAt?.message}>
        <Input
          type="date"
