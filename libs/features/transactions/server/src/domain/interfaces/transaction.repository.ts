...
export interface TransactionRepository {
   ...
   * deleted rows either.
   */
  findByIdForUserIncludingDeleted(id: string, userId: string): Promise<Transaction | null>;
   ...
   * supplied.
   */
  create(input: TransactionCreate, tx?: UnitOfWorkContext): Promise<Transaction>;
