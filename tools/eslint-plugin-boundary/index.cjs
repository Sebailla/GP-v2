 ...
 *   - no-import-type-injectable      (added by fix-api-nestjs-di)
...
const noImportTypeInjectable = require("./rules/no-import-type-injectable.cjs");
...
const plugin = {
  ...
  rules: {
    ...
    "no-import-type-injectable": noImportTypeInjectable,
...
plugin.configs = {
  recommended: {
    ...
    rules: {
      ...
      "@gpr/boundary/no-import-type-injectable": "error",
